...
public partial class organizerregister : System.Web.UI.Page
{
    ...
    protected void Button1_Click(object sender, EventArgs e)
    {
        ...
        if (useravailable)
        {
            if (TextBox6.Text == TextBox0.Text)
            {
                ...
                String oname = "OrganizerData1";
                con.Open();
                SqlCommand cmd = new SqlCommand(oname, con);
                ...
                cmd.ExecuteNonQuery();
                Response.Redirect("organizerlogin.aspx");
    ...
    public Boolean checkusername(String username)
    {
        Boolean userstatus;
        String mycon = "Data Source=DESKTOP-IEKF71P; Initial Catalog=Exhibition;Integrated Security=True";
        String myquery = "Select * from organizerregister where username='" + TextBox5.Text + "'";
        SqlConnection con = new SqlConnection(mycon);
